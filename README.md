...
|-----|--------|------------------------|------------|
| **Mikrotik_1** (Кронштадская) | 192.168.0.101 | 212.33.251.81:49091 | Winbox / SSH через NAT-порт |
| **Mikrotik_2** (Докучаева) | 192.168.2.1 | 46.146.223.193:49091 | Шлюз для dok_3korpus, SSH порт 49022 |
| **Mikrotik_3** (Чусовой) | 192.168.1.1 | 178.47.129.102:8291 | Winbox (стандартный порт) |
...
**Удалённое подключение (Winbox / SSH):** `<публичный_IP>:49091` — для Mikrotik_1 и Mikrotik_2. Учётные данные хранятся отдельно, не в репозитории.
